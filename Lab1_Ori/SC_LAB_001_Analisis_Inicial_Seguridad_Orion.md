...
| **3. Autenticación** | Identidad y credenciales de todos los usuarios | Persona que quiera autenticarse con credenciales que no sean suyas| Políticas débiles de contraseña, sin límite de intentos, o recuperación de acceso inseguro | Que se puede accedar a los perfiles ajenos con las credenciales | Suplantación del usuario y mal uso de las credenciales | Bloqueo tras intentos fallidos, validación en recuperación de contraseña, alertas ante inicios de sesión sospechosos |
